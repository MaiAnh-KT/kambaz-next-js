...
import { MdOutlineLibraryBooks, MdOutlineCalendarMonth } from "react-icons/md";
    ...
    >
      ...
      <ListGroupItem className="border-0 bg-black text-center">
        <Link
          ...
          className="text-white text-decoration-none"
        >
          <MdOutlineLibraryBooks className="fs-1 text-white" />
          <br />
          Courses
        </Link>
      </ListGroupItem>
      ...
      <ListGroupItem className="border-0 bg-black text-center">
        <Link
          ...
          className="text-white text-decoration-none"
        >
          <MdOutlineCalendarMonth className="fs-1 text-white" />
          <br />
          Calendar
        </Link>
      </ListGroupItem>
      ...
      <ListGroupItem className="border-0 bg-black text-center">
        <Link
          ...
          className="text-white text-decoration-none"
        >
          <FaRegEnvelope className="fs-1 text-white" />
          <br />
          Inbox
        </Link>
      </ListGroupItem>
      ...
      <ListGroupItem className="border-0 bg-black text-center">
        <Link
          ...
          className="text-white text-decoration-none"
        >
          <PiFlaskLight className="fs-1 text-white" />
          <br />
          Labs
        </Link>
      </ListGroupItem>
